...
function generateOptions() {
  ...
  options.value = opts
  correctIdx.value = opts.indexOf(word.mean)
}
...
.quiz-option { display: flex; align-items: center; gap: 10px; width: 100%; height: auto !important; padding: 14px 16px !important; border-radius: var(--radius-md) !important; border: 2px solid var(--color-border) !important; background: #FAFAFA !important; color: var(--color-text) !important; transition: all var(--transition-fast); white-space: normal; text-align: left; }
